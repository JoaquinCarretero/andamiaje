...
export function WelcomeSignatureModal({
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      // Subir archivo al servidor y actualizar sesión automáticamente
      ...
      // La respuesta incluye tanto el key de la firma como el usuario actualizado
      ...
      setError(
        error instanceof Error ? error.message : "Error al guardar la firma. Intente nuevamente."
      );
        ...
        <CardContent className="space-y-6">
          ...
          >
            ...
            <p className="text-base mb-4" style={{ color: colors.primary[600] }}>
              Para garantizar la seguridad y validez legal de sus documentos profesionales, debe
              registrar su firma digital antes de continuar.
            </p>
            <div
            ...
            >
              ...
              <span className="font-medium">
                Este paso es obligatorio y se realiza una sola vez
              </span>
            </div>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm space-y-2">
                ...
                >
                  ...
                  <li>
                    Será utilizada exclusivamente por mí para validar documentos profesionales
                  </li>
