...
import { Button, Badge, NotificationsModal } from "@/ui"
...
const roleTitle = AuthService.getRoleTitle(userData.role)
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-4">
              <Button
                ...
                aria-label="Abrir notificaciones. Tienes 5 notificaciones sin leer"
                title="Notificaciones (5)"
              >
